 ...
 * data:2019/1/15
 */
public class QuanbuDingdanAdapter extends RecyclerView.Adapter<QuanbuDingdanAdapter.ViewHolder> {
    private List<QuanbuDingdanBean.OrderListBean> list;
    private Context context;

    public QuanbuDingdanAdapter(List<QuanbuDingdanBean.OrderListBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        QuanbuDingdanBean.OrderListBean orderListBean = list.get(i);
        List<QuanbuDingdanBean.OrderListBean.DetailListBean> detailList = orderListBean.getDetailList();
